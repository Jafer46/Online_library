<?php
   ...
   $books = get_all_bookmarked_books($conn, $user_name);
    ...
    <div class="nav-container">
        ...
        <div class="left-bottom">
            ...
            <nav class="list-container">
                ...
                <a href="User.php" class="active">Library</a>
            ...
            <?php foreach($books as $book){ ?>                        
                <div class="card">
                    <div class="card-image" style="background-image: url(uploads/cover/<?=$book['cover']?>);">
                        <a href="php/unbookmark.php?id=<?=$book['id']?>"class="btn btn-blue">
                           <img src="images/icon/icons8-minus-24.png" alt="" width="20px">
                        </a>
